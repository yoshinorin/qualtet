...
import net.yoshinorin.qualtet.domains.models.articles.ArticleRepositoryDoobieInterpreter
import net.yoshinorin.qualtet.domains.models.contentTypes.{ContentType, ContentTypeRepositoryDoobieInterpreter}
